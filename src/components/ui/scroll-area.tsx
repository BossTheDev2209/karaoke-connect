...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      ...
      orientation === "vertical" && "h-full w-1.5 hover:w-2 border-l border-l-transparent p-px",
      orientation === "horizontal" && "h-1.5 hover:h-2 flex-col border-t border-t-transparent p-px",
      className,
    )}
    {...props}
  >
